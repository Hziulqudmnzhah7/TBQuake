...
void ClientBegin( int clientNum ) {
	...
	//************TESTING: Initializes iCurrentWeapon to 0 on first spawn
	client->iCurrentWeapon = 0;
	//**************************
...
//	char	*savedAreaBits;
	...
	int		eventSequence;
	char	userinfo[MAX_INFO_STRING];
	//*****************TESTING: Adding permanence to iCurrentWeapon
	int StoredWep = ent->client->iCurrentWeapon;
	//****************************
...
//	client->areabits = savedAreaBits;
	...
	//**********************TESTING: Set iCurrentWeapon back after new client called
	ent->client->iCurrentWeapon = StoredWep;
	//*********************************
	...
	*/
	if(client->iCurrentWeapon <= 0){
		client->iCurrentWeapon = 0;
	} else {
		client->iCurrentWeapon--;
	}
	Wof_ChangeWeapon(ent);
	//********************************
	...
	if ( level.intermissiontime ) {
		...
		//******************TESTING: Fix rocket launcher spawn problem
...
//***********************TESTING: Switch statememt for weapon choosing********************
int Wof_ChangeWeapon(gentity_t *ent)
{
