...
void player_die( gentity_t *self, gentity_t *inflictor, gentity_t *attacker, int damage, int meansOfDeath ) {
	...
	if (attacker && attacker->client) {
		...
		//***************TESTING: Cycle Weapon
			attacker->client->iCurrentWeapon++;
			//self->client->iCurrentWeapon--;
			Wof_ChangeWeapon(attacker);
...
//*************---***********************************/
	...
	//*******************TESTING: I may need to come back to this line later
	knockback = damage;
	//**********************
	if ( knockback > 200 ) {
		knockback = 200;
...
//*********---**********************************************/
	...
	/*********************TESTING: No damage rocket launcher?
	if ( attacker->client->) {
		damage = 0;
	}
	//***********/
	//*****************TESTING: No self damage: ROCKET JUMPING
	if ( targ == attacker) {
		damage = 0;
	}
